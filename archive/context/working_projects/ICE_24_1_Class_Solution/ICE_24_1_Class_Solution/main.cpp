...
//  4: Depth render for directional light
enum ObjectType {
    BASIC, 
    TEXTURED, 
    IMPORTED_BASIC, 
...
int main()
{
    ...
    shader_program.setVec4("directional_light.ambient",glm::vec4(0.1f*light_color,1.0));
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        glm::mat4 lightProjection = glm::ortho(-100.0f, 100.0f, 
                                               ...
                                               near_plane, 
                                               far_plane);
        glm::mat4 lightView = glm::lookAt(20.0f*glm::vec3(-light_direction), 
