...
int main()
{
    ...
    Shader skybox_program(".//shaders//skyboxVertex.glsl",".//shaders//skyboxFragment.glsl");
    ...
    unsigned int skybox_texture = GetCubeMap(faces,false);
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        //skybox cube
        //shader_program.setInt("shader_state",SKYBOX);
        skybox_program.use();
        glm::mat4 skybox_view = glm::mat4(glm::mat3(camera.GetViewMatrix()));
        skybox_program.setMat4("view",skybox_view);
        skybox_program.setMat4("projection",projection);
